"""
Base settings for EventSync project.
"""
import os
...
DATABASES = {
    'default': {
        ...
        'NAME': config('DB_NAME', default='eventsync'),
...
# Apps shared between all tenants (public schema)
SHARED_APPS = (
    'django_tenants',
    'apps.tenants',
    'apps.authentication',  # Users exist in both public and tenant schemas
...
CORS_ALLOW_PRIVATE_NETWORK = True  # Required for Chrome Private Network Access (localhost cross-port)
